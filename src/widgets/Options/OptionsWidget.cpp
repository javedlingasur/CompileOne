  ...
  ,m_EditorOptionsWidget( 0 )
{
    ...
    m_optiosTabWidget->setStyleSheet("QTabBar::tab { height: 0px; width: 0px; }");
    ...
    connect(m_optionsListWidget,&QListWidget::currentTextChanged,this,&OptionsWidget::ShowOptions);
}
